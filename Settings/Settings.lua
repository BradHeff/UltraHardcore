...
local presetIcons = {'Interface\\AddOns\\UltraHardcore\\textures\\skull' .. 1 .. '.png',
...
local function createCheckboxes()
    ...
    for _, checkboxItem in ipairs(settingsCheckboxOptions) do
        ...
        checkbox:SetScript('OnClick', function(self)
            ...
            -- Special handling for hidePlayerFrame setting to sync ElvUI DataTexts
            if checkboxItem.dbSettingsValueName == 'hidePlayerFrame' then
                SetPlayerFrameDisplay(self:GetChecked())
            end
        end)
