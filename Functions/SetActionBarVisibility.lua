...
function HideActionBars()
  ...
  -- Hide ElvUI action bars if ElvUI is loaded
  if UltraHardcore_ElvUI then
    UltraHardcore_ElvUI.HideElvUIActionBars()
  end
end
...
function ShowActionBars()
  ...
  -- Show ElvUI action bars if ElvUI is loaded
  if UltraHardcore_ElvUI then
    UltraHardcore_ElvUI.ShowElvUIActionBars()
  end
end
